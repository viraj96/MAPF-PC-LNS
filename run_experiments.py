...
def get_logfolder_name(args):
    ...
    dir_name = "Logs/"+args.baseline+"/"+str(current_time.year)+"_"+str(current_time.month)+"_"+str(current_time.day)+"_"+str(current_time.hour)+"_"+str(current_time.minute)+"_"+str(current_time.second)
    return dir_name
...
def main():
    ...
    parser.add_argument('--pwd', required=True, dest='dir', help='Working directory for the execution of the baseline')
